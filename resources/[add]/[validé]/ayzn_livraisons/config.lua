...
-- Locales
Config.Locales = {
	["delivery_not_available"]    = "Cette livraison est ~r~Indisponible~w~, utilisez la ~g~moto~w~ ou le~g~van~w~.",
	["start_delivery"]            = "Appuyez sur ~INPUT_CONTEXT~ pour commencer la livraison",
	["delivery_point_reward"]     = "Livraison terminée , vous recevez ~g~$",
	["get_back_in_vehicle"]       = "Entrez dans votre ~y~vehicule~s~",
	["remove_goods"]              = "Appuyez sur ~INPUT_CONTEXT~ pour prendre la ~y~marchandise ~s~du coffre",
	["remove_goods_subtext"]      = "Sortez de votre voiture et prenez la ~y~marchandise~w~",
	["drive_next_point"]          = "Conduisez jusqu'à la prochaine ~y~destination~w~",
	["deliver_inside_shop"]       = "Emmenez la  ~y~marchandise~w~ chez le client",
	["get_back_to_deliveryhub"]   = "Retournez au centre de livraison et rendez la voiture",
	["delivery_vehicle_returned"] = "Votre véhicule est rangée",
	["finish_job"]                = "Statut de la Mission : ~g~",
	["end_delivery"]              = "Appuyez sur ~INPUT_CONTEXT~ pour terminer la livraison",
	["blip_name"]                 = "Centre de Livraison",
	["dst_blip"]                  = "Livraison",
	["delivery_end"]              = "Fin de la Livraison",
	["delivery_failed"]           = "You lose the safe deposit because your car broken or lost",
	["delivery_finish"]           = "Vous avez fini vos livraisons",
	["delivery_start"]            = "Livraison",
	["delivery_tips"]             = "Conduit jusqu'à la destination et livre la ~y~marchandise~s~",
}