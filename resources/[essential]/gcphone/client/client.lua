...
Citizen.CreateThread(function()
  while true do
    ...
    if takePhoto ~= true then
      if IsControlJustPressed(1, KeyOpenClose) and (GetGameTimer() - GUI.Time) > 1500 then
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
			exports['screenshotbasic']:requestScreenshotUpload(data.url, data.field, function(data)
