...
RegisterServerEvent('gcPhone:tchat_channelayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzen')
AddEventHandler('gcPhone:tchat_channelayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzen', function(channel)
  local sourcePlayer = tonumber(source)
  TchatGetMessageChannel(channel, function(messages)
    TriggerClientEvent('gcPhone:tchat_channelayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzen', sourcePlayer, channel, messages)
  end)
end)
