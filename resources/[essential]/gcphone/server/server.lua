...
--[[     local numBase0 = '555' ]]
    --local numBase1 = math.random(0000000,9999999)
    local num = math.random(0000000,9999999)
    return num
end
  ...
  if PhoneNumbers[number] ~= nil then
    ...
    for k, _ in pairs(listSrc) do
      getPhoneNumber(tonumber(k), function(n)
        if n ~= nil then
          TriggerEvent('gcPhone:_internalAddMessageayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzen', number, n, mess, 0, function(smsMess)
...
RegisterServerEvent('gcPhone:_internalAddMessageayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzen')
AddEventHandler('gcPhone:_internalAddMessageayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzen', function(transmitter, receiver, message, owner, cb)
...
AddEventHandler('onMySQLReady', function()
    -- MySQL.Async.fetchAll("DELETE FROM phone_messages WHERE (DATEDIFF(CURRENT_DATE,time) > 10)") -- Supprimer Messages
end)
