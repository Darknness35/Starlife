...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedayyyzenayyyzenayyyzen')
AddEventHandler('esx_vehicleshop:setVehicleOwnedayyyzenayyyzenayyyzen', function (vehicleProps)
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedayyyzenayyyzenayyyzenPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleOwnedayyyzenayyyzenayyyzenPlayerId', function (playerId, vehicleProps)
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedayyyzenayyyzenayyyzenSociety')
AddEventHandler('esx_vehicleshop:setVehicleOwnedayyyzenayyyzenayyyzenSociety', function (society, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
