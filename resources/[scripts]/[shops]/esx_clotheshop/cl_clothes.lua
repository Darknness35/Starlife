...
function ClotheShopAdd(menu)
	...
	menu.OnItemSelect = function(_,_,ind)
		if ind == 1 then
			...
			local clotheShop2 = NativeUI.CreateMenu("StarClothes", "", 5, 100)
...
Citizen.CreateThread(function()
    ...
    for i = 1, #ConfigclotheShop.Map, 1 do
        ...
        AddTextComponentString("Vêtements - StarClothes")
...
local clotheShop = NativeUI.CreateMenu("StarClothes", "", 5, 100)
