...
Config.DamageMult = 3 -- Higher Number = Higher Repair Price. 5
...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = {x = -511.197, y = -602.736, z = 30.298},
		SpawnPoint = {x = -507.1213, y = -602.126, z = 29.298, h = 261.43},
		DeletePoint = {x = -509.3, y = -622.6447, z = 30.3}
	},
--[[ 	Garage_CentralHopitalLS = {
		GaragePoint = {x = 324.39, y = -618.4, z = 29.29},
		SpawnPoint = {x = 330.43, y = -621.53, z = 29.29, h = 247.47},
		DeletePoint = {x = 324.46, y = -625.52, z = 28.2}
	}, ]]
	Garage_Sandy = {
...
--[[ 	Garage_DelPerro = {
		GaragePoint = {x = -2026.967, y = -469.887, z = 11.402},
		SpawnPoint = {x = -2026.967, y = -469.887, z = 10.502, h = 319.86},
		DeletePoint = {x = -2034.7, y = -463.0, z = 10.406}
	}, ]]
	--[[ Garage_AeroportLS = {
		GaragePoint = {x = -977.216, y = -2710.379, z = 13.853},
		SpawnPoint = {x = -977.216, y = -2710.379, z = 13.853, h = 346.05},
		DeletePoint = {x = -966.8, y = -2709.9, z = 12.8}
	} ]]
--[[ 	Garage_NightClub = {
		GaragePoint = {x = -340.893, y = 266.831, z = 85.679},
		SpawnPoint = {x = -341.989, y = 271.862, z = 85.535, h = 269.65},
		DeletePoint = {x = -334.5, y = 300.9, z = 84.81}
	}, ]]
--[[ 	Garage_ShopPlage = {
		GaragePoint = {x = -3047.690, y = 590.298, z = 7.762},
		SpawnPoint = {x = -3051.117, y = 597.080, z = 6.762, h = 287.03},
		DeletePoint = {x = -3049.3, y = 610.1, z = 6.1}
	} ]]
}
...
Config.BoatGarages = {
	Garage_LSDock = {
		GaragePoint = {x = -719.15, y = -1325.75, z = 1.6},
		SpawnPoint = {x = -715.67, y = -1322.12, z = -0.47, h = 45.0},
		DeletePoint = {x = -725.38, y = -1327.86, z = -0.47}
	}
	--[[ Garage_SandyDock = {
