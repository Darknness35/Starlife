...
RegisterServerEvent('bank:depayyyzenosit')
AddEventHandler('bank:depayyyzenosit', function(amount)
...
RegisterServerEvent('bank:withdayyyzenraw')
AddEventHandler('bank:withdayyyzenraw', function(amount)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local base = 0
...
RegisterServerEvent('bank:tranayyyzensfer')
AddEventHandler('bank:tranayyyzensfer', function(to, amountt)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
