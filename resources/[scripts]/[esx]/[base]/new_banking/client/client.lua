...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('bank:depayyyzenosit', tonumber(data.amount))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('bank:withdayyyzenraw', tonumber(data.amountw))
	TriggerServerEvent('bank:balance')
end)
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('bank:tranayyyzensfer', data.to, data.amountt)
	TriggerServerEvent('bank:balance')
end)
