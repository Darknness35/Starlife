...
function OpenSinaloaActionsMenu()
    ...
    function(data, menu)
        menu.close()
        CurrentAction = 'sinaloa_actions_menu'
...
function OpensinaloaCloakroomMenu()
    ESX.UI.Menu.Open(
            'default', GetCurrentResourceName(), 'cloakroom_sinaloa',
            {
                title = 'cloakroom',
                align = 'top-left',
                elements = {
                    { label = 'Tenue Civil', value = 'citizen_wear' },
                    { label = 'Tenue sinaloa', value = 'sinaloa_wear' }
                },
            },
            function(data, menu)
                menu.close()
                ...
                CurrentAction = 'sinaloa_cloakroom_menu'
...
function OpensinaloaGarageMenu()
    local elements = {
        { label = 'Liste Véhicules', value = 'vehicle_list' }
    }
    ESX.UI.Menu.CloseAll()
    ESX.UI.Menu.Open(
            'default', GetCurrentResourceName(), 'sinaloa_garage',
            {
                title = 'sinaloa',
                elements = elements
            },
                        ...
                        ESX.TriggerServerCallback('esx_societyfaction:getVehiclesInGarage', function(vehicles)
                            ...
                            ESX.UI.Menu.Open(
                                    ...
                                    function(data, menu)
                                        ...
                                        ESX.Game.SpawnVehicle(vehicleProps.model, Config.Sinaloa.VehicleSinaloaSpawnPoint.Pos, 68.565, function(vehicle)
                                        ...
                                        TriggerServerEvent('esx_faction:removeVehicleFromGarageFaction', 'sinaloa', vehicleProps)
                                    end,
                                    function(data, menu)
                                        menu.close()
                                    end
                                ...
                                function(data, menu)
                                    ...
                                    for i = 1, #elements, 1 do
                                        ...
                                        if Config.MaxInService == -1 then
                                            ...
                                            ESX.Game.SpawnVehicle(data.current.value, Config.Sinaloa.VehicleSinaloaSpawnPoint.Pos, 68.565, function(vehicle)
                                                SetVehicleNumberPlateText(vehicle, "WPD" .. platenum)
                                                SetVehicleColours(vehicle, 12, 12)
                       							SetVehicleWindowTint(vehicle, 1)
                                                SetVehicleMaxMods(vehicle)
            ...
            function(data, menu)
                ...
                CurrentAction = 'sinaloa_garage_menu'
...
-- Stock Items sinaloa
function OpenGetStockssinaloaMenu()
    ESX.TriggerServerCallback('esx_sinaloa:getStockItemssinaloa', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if count == nil then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_sinaloa:getStockItemssinaloa', itemName, count)
...
function OpenPutStockssinaloaMenu()
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if count == nil then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_sinaloa:putStockItemssinaloa', itemName, count)
...
AddEventHandler('esx_sinaloa:hasEnteredMarkersinaloa', function(zone, station, part, partNum)

    if zone == 'SinaloaActions' then
        CurrentAction = 'sinaloa_actions_menu'
        CurrentActionMsg = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au menu.'
        CurrentActionData = {}
    elseif zone == 'CloakroomSinaloa' then
        CurrentAction = 'sinaloa_cloakroom_menu'
        CurrentActionMsg = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au vestiaire.'
        CurrentActionData = {}
    elseif zone == 'GarageSinaloa' then
        CurrentAction = 'sinaloa_garage_menu'
        CurrentActionMsg = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au garage.'
        CurrentActionData = {}
    elseif zone == 'VehicleSinaloaDeleter' then
        local playerPed = GetPlayerPed(-1)
...
AddEventHandler('esx_sinaloa:hasExitedMarkersinaloa', function(zone, station, part, partNum)
    ESX.UI.Menu.CloseAll()
    CurrentAction = nil
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if ESX.PlayerData.faction ~= nil and ESX.PlayerData.faction.name == 'sinaloa' then
            local playerPed = GetPlayerPed(-1)
            local coords = GetEntityCoords(GetPlayerPed(-1))

            for k, v in pairs(Config.Sinaloa) do
    ...
    while true do
        ...
        if ESX.PlayerData.faction ~= nil and ESX.PlayerData.faction.name == 'sinaloa' then
            ...
            if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastZone ~= currentZone or LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
                ...
                then
                    TriggerEvent('esx_sinaloa:hasExitedMarkersinaloa', LastZone, LastStation, LastPart, LastPartNum)
                    hasExited = true
                end
                ...
                TriggerEvent('esx_sinaloa:hasEnteredMarkersinaloa', currentZone, currentStation, currentPart, currentPartNum)
            end
...
function OpenGetWeaponMenu()
    ESX.TriggerServerCallback('esx_sinaloa:getArmoryWeapons', function(weapons)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon', {
            ...
            ESX.TriggerServerCallback('esx_sinaloa:removeArmoryWeapon', function()
                OpenGetWeaponMenu()
...
function OpenBuyWeaponsMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons', {
        ...
        if data.current.hasWeapon then
            ...
            ESX.TriggerServerCallback('esx_sinaloa:buyWeapon', function(bought)
                if bought then
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlPressed(0, 38) and ESX.PlayerData.faction ~= nil and ESX.PlayerData.faction.name == 'sinaloa' and (GetGameTimer() - GUI.Time) > 300 then

                if CurrentAction == 'sinaloa_actions_menu' then
                    OpenSinaloaActionsMenu()
                elseif CurrentAction == 'sinaloa_cloakroom_menu' then
                    OpenSinaloaCloakroomMenu()
                elseif CurrentAction == 'sinaloa_garage_menu' then
                    OpenSinaloaGarageMenu()
...
-- TELEPORTERS
AddEventHandler('esx_sinaloa:teleportMarkers', function(position)
...
Citizen.CreateThread(function()
  while true do
    ...
    if ESX.PlayerData.faction ~= nil and ESX.PlayerData.faction.name == 'sinaloa' then
      ...
      for k,v in pairs(Config.TeleportZonessinaloa) do
  ...
  while true do
    ...
    if  ESX.PlayerData.faction ~= nil and  ESX.PlayerData.faction.name == 'sinaloa' then
      ...
      if IsControlJustReleased(0, 38) and isInPublicMarker then
        TriggerEvent('esx_sinaloa:teleportMarkers', position)
      end
...
function OpenGetWeaponssinaloa()
    ESX.TriggerServerCallback('esx_sinaloa:getsinaloaWeapons', function(weapons)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon', {
            ...
            ESX.TriggerServerCallback('esx_sinaloa:removesinaloaWeapon', function()
                OpenGetWeaponssinaloa()
            end, data.current.value)
        end, function(data, menu)
            menu.close()
...
function OpenPutWeaponssinaloa()
    local elements = {}
    local playerPed = PlayerPedId()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon', {
        ...
        menu.close()
        ESX.TriggerServerCallback('esx_sinaloa:addsinaloaWeapon', function()
            OpenPutWeaponssinaloa()
...
function OpenGetBlackMoneySinaloa()
        ...
        function(data, menu)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_sinaloa:getBlackMoney', data.current.type, data.current.value, tonumber(data2.value))
  ...
  function OpenPutBlackMoneySinaloa()
  
    ESX.TriggerServerCallback('esx_sinaloa:getBlackMoney', function(inventory)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                menu.close()
                TriggerServerEvent('esx_sinaloa:getPutMoney', data.current.type, data.current.value, quantity)
                ESX.SetTimeout(300, function()
                  OpenPutBlackMoneySinaloa()
                end)
              end
