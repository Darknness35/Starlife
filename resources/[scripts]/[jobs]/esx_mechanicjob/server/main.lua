...
RegisterServerEvent('esx_mechanicjob:starayyyzentCraft')
AddEventHandler('esx_mechanicjob:starayyyzentCraft', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starayyyzentCraft2')
AddEventHandler('esx_mechanicjob:starayyyzentCraft2', function()
	local _source = source
...
RegisterServerEvent('esx_mechanicjob:starayyyzentCraft3')
AddEventHandler('esx_mechanicjob:starayyyzentCraft3', function()
	local _source = source
