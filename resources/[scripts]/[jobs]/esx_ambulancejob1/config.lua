...
Config.RespawnPoint = {coords = vector3(298.53, -584.53, 43.26), heading = 155.64}

Config.Hospitals = {

	CentralLosSantos = {
		Blip = {
			coords = vector3(286.6, -582.8, 43.3),
			sprite = 61,
			scale = 0.9,
			color = 2
		},
		AmbulanceActions = {
			vector3(310.283, -595.5151, 43.284)
		},
		Pharmacies = {
			vector3(310.45782, -563.4767, 43.284)
		},
		Vehicles = {
			{
				...
				SpawnPoints = {
					{ coords = vector3(326.0, -565.9, 28.5), heading = 340.0, radius = 4.0 },
					{ coords = vector3(337.4, -569.5, 28.5), heading = 341.1, radius = 4.0 }
				}
			}
		},
		Helicopters = {
			{
				...
				InsideShop = vector3(315.8, -576.6, 94.5),
				Marker = { type = 34, x = 1.5, y = 1.5, z = 1.5, r = 100, g = 150, b = 150, a = 100, rotate = true },
				SpawnPoints = {
					{ coords = vector3(351.8, -587.7, 74.2), heading = 190.1, radius = 10.0 }
				}
			}
		}
--[[ 		FastTravels = {
