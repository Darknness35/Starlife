...
RegisterServerEvent('esx_ambulancejob:reayyyzenvive')
AddEventHandler('esx_ambulancejob:reayyyzenvive', function(target)
	...
	if societyAccount then
		if xPlayer.job.name == 'ambulance' then
			...
			TriggerClientEvent('esx_ambulancejob:reayyyzenvive', target)
		else
...
TriggerEvent('es:addGroupCommand', 'revive', 'mod', function(source, args, user)
	if args[1] ~= nil then
		if GetPlayerName(tonumber(args[1])) ~= nil then
			...
			TriggerClientEvent('esx_ambulancejob:reayyyzenvive', tonumber(args[1]))
		end
	else
		TriggerClientEvent('esx_ambulancejob:reayyyzenvive', source)
	end
