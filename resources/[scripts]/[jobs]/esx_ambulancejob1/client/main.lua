...
function RemoveItemsAfterRPDeath()
    ...
    Citizen.CreateThread(function()
        ...
        ESX.TriggerServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function()
            ...
            ESX.SetPlayerData('lastPosition', Config.RespawnPoint)
            ESX.SetPlayerData('loadout', {})

            TriggerServerEvent('esx:updateLastPosition',Config.RespawnPoint)

            RespawnPed(GetPlayerPed(-1), Config.RespawnPoint)
...
RegisterNetEvent('esx_ambulancejob:reayyyzenvive')
AddEventHandler('esx_ambulancejob:reayyyzenvive', function()
	local playerPed = PlayerPedId()
	local coords = GetEntityCoords(playerPed)
	TriggerServerEvent('esx_ambulancejob:setDeathStatus', false)
