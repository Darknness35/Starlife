...
function OpenAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'ambulance_actions', {
		...
		elseif data.current.value == 'boss_actions' then
			TriggerEvent('esx_society:openBosayyyzensMenu', 'ambulance', function(data, menu)
				menu.close()
			end, {wash = false})
		end
						...
						ESX.UI.Menu.Open(
							...
							function(data, menu)
								...
								if amount == nil then
									...
									menu.close()							
									TriggerServerEvent('esx_biayyyzenlling:sendBill', GetPlayerServerId(closestPlayer), 'society_ambulance', 'ambulance', amount)
								end
							end,
						function(data, menu)
							menu.close()
						...
						ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if IsPedDeadOrDying(closestPlayerPed, 1) then
									...
									TriggerServerEvent('esx_ambulancejob:reayyyzenvive', GetPlayerServerId(closestPlayer))
