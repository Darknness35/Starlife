...
function MenuCloakRoom()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	{
		...
		elements = {
			...
			{ label = 'Tenue Livreur',    value = 'job_wear'}
		}
	}, function(data, menu)
...
function donnerlapaye()
	...
	if vievehicule >= 1 then
		if livraisonTotalPaye == 0 then
			...
			TriggerServerEvent("esx_pizza:payyyzenayyyzenayyyzenayyyzenayyyzenayyyzenayyyzenay", amount)
...
function donnerlapayesanscamion()
	...
	-- donne paye
	local amount = livraisonTotalPaye
